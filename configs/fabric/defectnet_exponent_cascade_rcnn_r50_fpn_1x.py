...
model = dict(
    ...
    # y=kw0/(a**(n/T)), T=n/(log_a(kw0/y))=3830*12/(math.log(1/0.001))=6653.4
    # n=0, y=1; n=3830*12, y=0.001;
...
log_level = 'INFO'
work_dir = '../work_dirs/' + dataset_name + '/defectnet_exponent_cascade_rcnn_r50_fpn_1x'
resume_from = None
