...
train_pipeline = [
    ...
    dict(type='CutROI'),
    dict(type='CutImage', window=(1000, 1000), step=(500, 500)),
...
test_pipeline = [
    ...
    dict(type='CutImage', training=False, window=(1000, 1000), step=(500, 500),
         order_index=False),
    dict(
...
log_level = 'INFO'
work_dir = '../work_dirs/' + dataset_name + '/baseline_model_cut_ROI_cut_1000x1000'
resume_from = None
