...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(667, 2000), (400, 1200)], keep_ratio=True, multiscale_mode='range'),
...
log_level = 'INFO'
work_dir = '../work_dirs/' + dataset_name + '/baseline_model_mst_range_667x2000_400x1200'
resume_from = None
