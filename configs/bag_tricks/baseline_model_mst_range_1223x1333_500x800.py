...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(1223, 1333), (500, 800)], keep_ratio=True, multiscale_mode='range'),
...
log_level = 'INFO'
work_dir = '../work_dirs/' + dataset_name + '/baseline_model_mst_range_1223x1333_500x800'
resume_from = None
