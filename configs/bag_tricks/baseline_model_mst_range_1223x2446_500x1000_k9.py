...
log_level = 'INFO'
work_dir = '../work_dirs/' + dataset_name + '/baseline_model_mst_range_1223x2446_500x1000_k9'
resume_from = None
load_from = '../work_dirs/bag_tricks/baseline_model_mst_range_1223x2446_500x1000/epoch_12.pth'
workflow = [('train', 1)]
