...
log_level = 'INFO'
work_dir = '../work_dirs/' + dataset_name + '/defectnet/defectnet_inverse_mst_range_1223x2446_500x1000'
resume_from = None
load_from = '../work_dirs/bag_tricks/defectnet/defectnet_inverse/epoch_12.pth'
workflow = [('train', 1)]
