...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(1223, 500), (1333, 800)], keep_ratio=True, multiscale_mode='value'),
...
log_level = 'INFO'
work_dir = '../work_dirs/' + dataset_name + '/baseline_model_mst_value_1223x500_1333x800'
resume_from = None
