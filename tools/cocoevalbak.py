...
class COCOeval:
    ...
    def _summarize(self, ap=1, iouThr=None, areaRng='all', maxDets=100, ignore_ids=None):
        p = self.params
        ...
        line = iStr.format(titleStr, typeStr, iouStr, areaRng, maxDets, mean_s)
        print(line)
        return mean_s, line

    def summarize(self, ignore_ids=None):
        '''
